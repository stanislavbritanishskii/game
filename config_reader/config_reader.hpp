...
private:
	...
	MapData map_data;
	std::string path_to_projectile_config;
	float ratio;
...
public:
	...
	void loadFromJSON(const std::string& filename) {
		...
		path_to_projectile_config = json_data.contains("projectiles_config") ? json_data["projectiles_config"].get<std::string>() : "";
	...
	std::string getPathToProjectileConfig()
	{
		return path_to_projectile_config;
	}
};
